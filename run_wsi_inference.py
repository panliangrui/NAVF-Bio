    ...
    for file_idx, rel_path, slide_file in slide_files:
        ...
        if not os.path.exists(res_file):
            ...
            outputs = analyze_one_slide(model, dataset,
                                        compute_masks=not args.box_only,#not args.box_only,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='./input')#"P:\\LUAD\\TCGA-4B-A93V-01Z-00-DX1.C263DC1C-298D-47ED-AAF8-128043828530.svs",help="input data filename or directory.")#M:\\P53\\P53-svs\\svs
    ...
    parser.add_argument('--output_dir', default="./output1", type=str, help="Output folder.")
    ...
    parser.add_argument('--max_memory', default=8000, type=int,
                        help='Maximum MB to store masks in memory. Default is 80%% of free memory.')
    parser.add_argument('--box_only', action='store_true', default=True, help="Only save box and ignore mask.")
    ...
    parser.add_argument('--export_text', action='store_true', default=True,
                        help="If save_csv is enabled, whether to convert numeric labels into text.")
    parser.add_argument('--export_mask', action='store_true', default=True,
