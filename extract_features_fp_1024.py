...
def compute_w_loader(file_path, output_path, wsi, model,
    ...
    for count, (batch, coords) in enumerate(loader):
        with torch.no_grad():
            ...
            # ##获取细胞的特征
            #
            # model = DeepCMorph(num_classes=7)
...
parser.add_argument('--data_h5_dir', type=str,
                    default='./features/RESULTS_DIRECTORY_1024')
parser.add_argument('--data_slide_dir', type=str, default='./input')
parser.add_argument('--slide_ext', type=str, default='.svs')
parser.add_argument('--csv_path', type=str,
                    default='./features/RESULTS_DIRECTORY_1024/process_list_autogen.csv')
parser.add_argument('--feat_dir', type=str,
                    default='./features/FEATURES_DIRECTORY_1024')
