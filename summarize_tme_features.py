...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_res_path', default="./output1", type=str,
                        help="The detection/segmentation result folder." )
    parser.add_argument('--output_dir', default="./output", type=str, help="The output folder.")
    ...
    parser.add_argument('--n_classes', default=3, type=int, help='Number of nuclei types in analysis.')
    ...
    parser.add_argument('--box_only', action='store_true', default=False, help='Ignore nuclei mask morphological features.')
    parser.add_argument('--save_nuclei', action='store_true', default=True, help='Store nuclei morphological features into a csv file.')
    parser.add_argument('--save_images', action='store_true', default=True,help='Store img, dots, densities, roi masks.')
